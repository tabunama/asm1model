...
asm1model Python package (2026). Taher Abunama, Xavier Flores-Alsina, Krist V. Gernaey and Ulf Jeppsson.


Upstream license agreement and attribution
------------------------------------------

The asm1model package is based on a ASM1 / BSM1 implementation within the BSM1 framework.
